...
public class UpdateCustomer extends JFrame {
	...
	public UpdateCustomer(String username) throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                Image i3 = i1.getImage().getScaledInstance(150, 200,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel l1 = new JLabel(i2);
                l1.setBounds(550,150,150,200);
                add(l1);
		
		JLabel lblName = new JLabel("UPDATE DETAILS");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s7 =  t7.getText(); 
                                ...
                                String insertQuery = "INSERT INTO customer (id_type, number, name, gender, country, address, phone, email, username) VALUES ('" + s2 + "', '" + s3 + "', '" + s4 + "', '" + s5 + "', '" + s6 + "', '" + s7 + "', '" + s8 + "', '" + s9 + "', '" + s1 + "')";
